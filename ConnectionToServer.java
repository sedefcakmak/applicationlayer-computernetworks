    ...
    public String SendForAnswer(String message)
    {
        ...
        try
        {
             ...
             */
             ...
             //editing message according to protocol
            if ((message.compareTo("0"))==0) {
                ...
                System.out.println("Enter coinnames");
                query = scanner.nextLine();
                resp="null";
            }
            else {
                System.out.println("Only enter the action you wanna perform 0/1?");
            }
            prot=mtype+":"+query+":"+resp;
            os.println(prot);
            os.flush();
             ...
             */
            //puts the response also in protocol and gets it from there
            resp = is.readLine();
            prot=mtype+":"+query+":"+resp;
            String [] a= prot.split(":");
            response=a[2];
